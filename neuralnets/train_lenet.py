...
optimizer = SVRG(
    network.parameters(),
    lr=0.005,# good 0.01, 0.05 hella stable, goes very low on loss, 0.001 also kinda stable but doesnt get as low as 0.05
    prob=1/np.sqrt(num_steps), #1 / np.sqrt(len(train_loader.dataset)),
    nn=network_temp,
    loss_func=criterion,
